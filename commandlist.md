...
Version: `NadekoBot v0.9.6029.18008`
### Help  
...
`e`  |  Custom reaction. | e
`@BotName insult`, `<@!199559864278712321> insult`  |  Custom reaction. | %mention% insult
`@BotName praise`, `<@!199559864278712321> praise`  |  Custom reaction. | %mention% praise
`@BotName pat`, `<@!199559864278712321> pat`  |  Custom reaction. | %mention% pat
`@BotName cry`, `<@!199559864278712321> cry`  |  Custom reaction. | %mention% cry
`@BotName are you real?`, `<@!199559864278712321> are you real?`  |  Custom reaction. | %mention% are you real?
`@BotName are you there?`, `<@!199559864278712321> are you there?`  |  Custom reaction. | %mention% are you there?
`@BotName draw`, `<@!199559864278712321> draw`  |  Custom reaction. | %mention% draw
`@BotName bb`, `<@!199559864278712321> bb`  |  Custom reaction. | %mention% bb
`@BotName call`, `<@!199559864278712321> call`  |  Custom reaction. | %mention% call
`@BotName disguise`, `<@!199559864278712321> disguise`  |  Custom reaction. | %mention% disguise
